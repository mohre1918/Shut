...
def Dashboard(request):
    from NEWPROJECT import period_result2Postgres
    from NEWPROJECT import duration_per_operator_result2Postgres
    from NEWPROJECT import duration_per_province_result2Postgres
